    ...
    import("@line/liff")
      ...
      .then(async (liffObj) => {
        ...
        if (liffObj.isLoggedIn()) {
          ...
          if (idToken && isTokenExpired(idToken) && requireLogin && !liffObj.isInClient()) {
            // Outside LINE: show re-login prompt (in LINE client, user is always logged in — skip expiry check)

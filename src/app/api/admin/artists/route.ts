...
export async function GET() {
  ...
  const { data, error } = await supabase
    .from("artists")
    .select("id, display_name, avatar_url, phone, email, gender, cities, services, styles, min_price, max_price, instagram_handle, bio, line_user_id, is_verified, is_active, created_at")
